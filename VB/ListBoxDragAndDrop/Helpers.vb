...
Namespace ListBoxDragAndDrop
    ...
    Public Module DataHelper
        ...
        Public Function GenerateCustomers() As ObservableCollection(Of Customer)
            Return New ObservableCollection(Of Customer)() From {New Customer() With {.FirstName = "John", .LastName = "Cassano"}, New Customer() With {.FirstName = "Michael", .LastName = "Osvald"}, New Customer() With {.FirstName = "Miles", .LastName = "Keaton"}, New Customer() With {.FirstName = "Tim", .LastName = "Devenport"}}
        End Function
    End Module
    ...
    Public Module RichEditHelper
        ...
        Public Function GetDocumentPositionFromWindowsPoint(ByVal richEditControl As RichEditControl, ByVal windowsPoint As Point) As DocumentPosition
            Dim drawingPoint As System.Drawing.PointF = New System.Drawing.PointF(Units.PixelsToDocumentsF(CSng(windowsPoint.X), richEditControl.DpiX), Units.PixelsToDocumentsF(CSng(windowsPoint.Y), richEditControl.DpiY))
